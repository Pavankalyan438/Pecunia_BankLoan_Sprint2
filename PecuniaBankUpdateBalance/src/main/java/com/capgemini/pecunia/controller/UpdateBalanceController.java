...
public class UpdateBalanceController {
	...
	// controller level exception to handle any unexpected exceptions occurred at
	// this particular controller level
	@ResponseStatus(value = HttpStatus.BAD_REQUEST, reason = "Cannot be null")
